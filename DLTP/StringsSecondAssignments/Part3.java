...
/**
 * Finds how many genes are found within a DNA sequence
 * 
 * @author (your name) 
...
public class Part3 {
    ...
    public int countGenes(String dna){
        ...
        int temp = Math.min(taaIndex, tagIndex);
        int minIndex = Math.min(temp, tgaIndex);
        //The amount of genes there are in this strand of DNA
        int count = 0;
        if (startIndex == -1 || startIndex >= minIndex || minIndex == length){
            return count;
        }
    ...
    public void testCountGenes(){
        ...
        System.out.println(countGenes("TAAATGTAAGGGTTTATGGGGGGGTGAATGGGGGGGGGGGGGTAGATGGGGGGG"));
        System.out.println(countGenes(noATG));
        System.out.println(countGenes(oneValid));
        System.out.println(countGenes(multipleValid));
        System.out.println(countGenes(noStop));
        System.out.println(countGenes(fifth));
    }
}
